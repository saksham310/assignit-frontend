            ...
            <Accordion type={"single"} collapsible defaultValue={'task' }>
                <AccordionItem value={'task'}>
                    <Card className={'shadow-none border-none'}>
                        <CardHeader className={'px-3 py-2 hover:bg-[#f6f8fb]'}>
                            <div className={'flex justify-between items-center'}>
                                <span><Badge variant={'outline'} className={'border-green-500 text-green-500'}>Completed</Badge></span>
                                <AccordionTrigger/>
                            </div>
                        </CardHeader>
                        <AccordionContent>
            ...
            <Accordion type={"single"} collapsible defaultValue={'task' }>
                <AccordionItem value={'task'}>
                    <Card className={'shadow-none border-none'}>
                        <CardHeader className={'px-3 py-2 hover:bg-[#f6f8fb]'}>
                            <div className={'flex justify-between items-center'}>
                                <span><Badge variant={'outline'} className={'border-amber-500 text-amber-500'}>In Progress</Badge></span>
                                <AccordionTrigger/>
                            </div>
                        </CardHeader>
                        <AccordionContent>
                ...
                <AccordionItem value={'task'}>
                    <Card className={'shadow-none border-none'}>
                        <CardHeader className={' border-[#f6f8fb] rounded-lg px-3 py-2 mb-1 hover:bg-[#f6f8fb]'}>
                            <div className={'flex justify-between items-center'}>
                                <span><Badge variant={'outline'} className={'border-purple-500 text-purple-500'}>Sprint Backlog</Badge></span>
                                <AccordionTrigger/>
                            </div>
                        </CardHeader>
                        <AccordionContent>
