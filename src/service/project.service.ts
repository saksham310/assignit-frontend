...
import {
    ...
    ProjectResponse,
    ProjectStatusMembersResponse,
    ProjectRetrospective,
    RetrospectivePayload,
    RetrospectiveResponse,
    SprintCreationPayload,
    Status
...
export const getProjects = async (id: string | undefined): Promise<ProjectResponse[]> => {
...
export const getProjectDetails = async (id: string | undefined): Promise<ProjectDetailsResponse> => {
    const res = await apiClient.get(GET_PROJECT_DETAILS(id as string));
    return res.data;
}

export const getProjectMembers = async (id: string | undefined): Promise<ProjectMembersResponse> => {
    const res = await apiClient.get(GET_PROJECT_MEMBERS(id as string));
    return res.data;
}

export const getProjectStatus = async (id: string | undefined): Promise<ProjectStatusMembersResponse> => {
    const res = await apiClient.get(GET_PROJECT_STATUS_MEMBERS(id as string));
    return res.data;
}

export const getProjectRetrospective = async (id: string | undefined): Promise<{projects: ProjectRetrospective[]}> => {
...
export const getRetrospectiveFeedbacks = async (id:number): Promise<RetrospectiveResponse> => {
